...
class ResultadoMatching {
  ...
  final List<int> partidosSinEmparejar; // IDs de partidos que no pudieron emparejarse
...
class MatchingSolver {
  ...
  ResultadoMatching resolver({
    ...
    final grafoPriorizado =
        graphBuilder.construirGrafoPriorizado(gallosDisponibles);
  ...
  ResultadoMatching? _backtracking({
    ...
    void buscar(
      ...
      for (var i = indiceArista; i < aristas.length; i++) {
        ...
        // Tomar esta arista
        paresActuales.add(ParEmparejado(
          galloA: arista.galloA,
          galloB: arista.galloB,
          diferencia: arista.peso,
        ));
        ...
        buscar(i + 1, paresActuales, partidosUsados, gallosUsados,
