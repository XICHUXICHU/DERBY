...
void main() {
  ...
  final partidos = List.generate(
    21,
    (i) => Partido(id: i + 1, nombre: 'P${i + 1}'),
  );
  ...
  for (var r in rondas) {
    ...
    print(
      'Ronda ${r.numero}: ${r.enfrentamientos.length} peleas, excluidos: ${r.partidosBye}',
    );
  }
